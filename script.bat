...
set RANKED_ARTICLES_VIEW_FILE=%5
...
docker cp "%RANKED_ARTICLES_VIEW_FILE%" "%CONTAINER_NAME%:/RANKED_ARTICLES_VIEW.sql"
...
docker exec -it "%CONTAINER_NAME%" psql -U "%DB_USER%" -d "%DB_NAME%" -f /RANKED_ARTICLES_VIEW.sql