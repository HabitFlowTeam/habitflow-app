...
set USER_HABIT_TRACKING_VIEW_FILE=%5
if "%USER_HABIT_TRACKING_VIEW_FILE%"=="" set USER_HABIT_TRACKING_VIEW_FILE=sql\USER_HABIT_TRACKING_VIEW.sql
...
docker cp "%USER_HABIT_TRACKING_VIEW_FILE%" "%CONTAINER_NAME%:/USER_HABIT_TRACKING_VIEW.sql"
...
docker exec -it "%CONTAINER_NAME%" psql -U "%DB_USER%" -d "%DB_NAME%" -f /USER_HABIT_TRACKING_VIEW.sql